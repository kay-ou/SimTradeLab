...
from simtradelab.backtest.plugins.base import Order, MarketData, PluginMetadata
...
class TestDynamicSlippageModel:
    ...
    def test_volatility_impact_calculation(self):
        ...
        high_vol_slippage = model.calculate_slippage(order, high_volatility_data, fill_price)
        low_vol_slippage = model.calculate_slippage(order, low_volatility_data, fill_price)

...
def test_validate_default_config(monkeypatch):
    ...
    config = ConfigValidator.validate(TestPluginConfig, VALID_CONFIG_DATA, env="default")
...
def test_validate_production_config_overrides_default(monkeypatch):
    ...
    config = ConfigValidator.validate(TestPluginConfig, VALID_CONFIG_DATA, env="production")
...
def test_validate_development_config_with_env_variable(monkeypatch):
    ...
    config = ConfigValidator.validate(TestPluginConfig, VALID_CONFIG_DATA, env="development")

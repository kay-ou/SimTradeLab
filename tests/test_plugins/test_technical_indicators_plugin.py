...
from simtradelab.plugins.indicators.technical_indicators_plugin import TechnicalIndicatorsPlugin
...
class TestTechnicalIndicatorsPlugin:
    ...
    def test_calculate_macd(self, plugin):
        ...
        close_data = np.array([10.0, 10.1, 10.2, 9.9, 10.3, 10.4, 10.1, 10.5, 10.6, 10.0,
                              10.2, 10.3, 10.1, 10.4, 10.5, 10.2, 10.6, 10.7, 10.3, 10.8])
    ...
    def test_calculate_kdj(self, plugin):
        ...
        high_data = np.array([10.2, 10.3, 10.4, 10.1, 10.5, 10.6, 10.3, 10.7, 10.8, 10.2,
                             10.4, 10.5, 10.3, 10.6, 10.7, 10.4, 10.8, 10.9, 10.5, 11.0])
        low_data = np.array([9.8, 9.9, 10.0, 9.7, 10.1, 10.2, 9.9, 10.3, 10.4, 9.8,
                            10.0, 10.1, 9.9, 10.2, 10.3, 10.0, 10.4, 10.5, 10.1, 10.6])
        close_data = np.array([10.0, 10.1, 10.2, 9.9, 10.3, 10.4, 10.1, 10.5, 10.6, 10.0,
                              10.2, 10.3, 10.1, 10.4, 10.5, 10.2, 10.6, 10.7, 10.3, 10.8])
...
class TestPTradeAdapterIntegration:
    ...
    def mock_plugin_manager(self):
        ...
        indicators_plugin = TechnicalIndicatorsPlugin(
            TechnicalIndicatorsPlugin.METADATA,
            PluginConfig()
        )

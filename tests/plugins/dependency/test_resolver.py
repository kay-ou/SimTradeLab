...
class TestDependencyResolver:
    ...
    def test_resolve_simple_dependency(self, registry: PluginRegistry):
        """测试解析简单的依赖关系"""
        plugin_a = PluginManifest(name="plugin_a", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY)
        plugin_b = PluginManifest(name="plugin_b", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, dependencies={"plugin_a": ">=1.0.0"})
    ...
    def test_circular_dependency(self, registry: PluginRegistry):
        """测试循环依赖"""
        plugin_a = PluginManifest(name="plugin_a", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, dependencies={"plugin_b": ">=1.0.0"})
        plugin_b = PluginManifest(name="plugin_b", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, dependencies={"plugin_a": ">=1.0.0"})
        registry.register_plugin(plugin_a)
        registry.register_plugin(plugin_b)
        resolver = DependencyResolver(registry)
    ...
    def test_missing_dependency(self, registry: PluginRegistry):
        """测试缺失依赖"""
        plugin_a = PluginManifest(name="plugin_a", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, dependencies={"non_existent": ">=1.0.0"})
        registry.register_plugin(plugin_a)
        resolver = DependencyResolver(registry)
    ...
    def test_version_conflict(self, registry: PluginRegistry):
        """测试版本冲突"""
        plugin_a = PluginManifest(name="plugin_a", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY)
        plugin_b = PluginManifest(name="plugin_b", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, dependencies={"plugin_a": ">=2.0.0"})
        registry.register_plugin(plugin_a)
        registry.register_plugin(plugin_b)
        resolver = DependencyResolver(registry)
    ...
    def test_dependency_conflict(self, registry: PluginRegistry):
        """测试插件冲突"""
        plugin_a = PluginManifest(name="plugin_a", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, conflicts=["plugin_b"])
        plugin_b = PluginManifest(name="plugin_b", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY)
        registry.register_plugin(plugin_a)
        registry.register_plugin(plugin_b)
        resolver = DependencyResolver(registry)
    ...
    def test_check_compatibility(self, registry: PluginRegistry):
        ...
        plugin_a = PluginManifest(name="plugin_a", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, conflicts=["plugin_b"])
        plugin_b = PluginManifest(name="plugin_b", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY)
        plugin_c = PluginManifest(name="plugin_c", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, dependencies={"plugin_a": ">=2.0.0"})
    ...
    def test_get_dependency_tree(self, registry: PluginRegistry):
        ...
        plugin_a = PluginManifest(name="plugin_a", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY)
        plugin_b = PluginManifest(name="plugin_b", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, dependencies={"plugin_a": ">=1.0.0"})
        plugin_c = PluginManifest(name="plugin_c", version="1.0.0", description="d", author="a", category=PluginCategory.UTILITY, dependencies={"plugin_b": ">=1.0.0"})
        registry.register_plugin(plugin_a)
        registry.register_plugin(plugin_b)

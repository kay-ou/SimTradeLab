...
class TestPTradeStrategyLifecycle:
    ...
    def test_execute_strategy_hook(self, adapter):
        ...
        try:
            ...
            # 测试钩子执行
            result = adapter.execute_strategy_hook('handle_data', adapter._ptrade_context, {'test': 1})
            assert result == 1
            ...
            with pytest.raises(PTradeAPIError):
                adapter.execute_strategy_hook('invalid_hook', adapter._ptrade_context, {})

...
from src.simtradelab.adapters.ptrade.models import Portfolio, Blotter
...
class TestTradingService:
    ...
    def test_execute_order_value(self):
        ...
        with patch.object(self.service, '_get_market_price', return_value=10.0):
            with patch.object(self.service, 'execute_order', return_value="order_123") as mock_execute:
    ...
    def test_cancel_order_ex(self):
        ...
        with patch.object(self.service, 'cancel_order', return_value=True) as mock_cancel:
    ...
    def test_execute_after_trading_order(self):
        ...
        with patch('uuid.uuid4') as mock_uuid:
            ...
            result = self.service.execute_after_trading_order(security, amount, limit_price)

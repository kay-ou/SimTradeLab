...
from simtradelab.plugins.base import PluginMetadata, PluginConfig, PluginState
...
class TestAPIRouterAdvanced:
    ...
    def test_concurrent_health_checks(self, multiple_endpoints):
        ...
        for i, endpoint in enumerate(multiple_endpoints):
            ...
            thread = threading.Thread(target=modify_endpoint_stats, args=(endpoint, success_rate))
